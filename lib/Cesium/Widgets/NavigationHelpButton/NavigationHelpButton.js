...
cesiumSvgPath: { path: _svgPath, width: 32, height: 32 }');
        ...
        mouseButton.appendChild(document.createTextNode('Souris'));
        ...
        touchButton.appendChild(document.createTextNode('Toucher'));
        ...
        clickInstructions.innerHTML = '\
            <table>\
                <tr>\
                    ...
                    <td>\
                        <div class="cesium-navigation-help-pan">Déplacer la vue</div>\
                        <div class="cesium-navigation-help-details">Clic gauche + déplacer</div>\
                    </td>\
                </tr>\
                <tr>\
                    <td><img src="' + buildModuleUrl('Widgets/Images/NavigationHelp/MouseRight.svg') + '" width="48" height="48" /></td>\
                    <td>\
                        <div class="cesium-navigation-help-zoom">Zoomer</div>\
                        <div class="cesium-navigation-help-details">Clic droit + déplacer, ou</div>\
                        <div class="cesium-navigation-help-details">Faire défiler la molette</div>\
                    </td>\
                </tr>\
                <tr>\
                    <td><img src="' + buildModuleUrl('Widgets/Images/NavigationHelp/MouseMiddle.svg') + '" width="48" height="48" /></td>\
                    <td>\
                        <div class="cesium-navigation-help-rotate">Changer l\'orientation</div>\
                        <div class="cesium-navigation-help-details">Clic molette + déplacer, ou</div>\
                        <div class="cesium-navigation-help-details">CTRL + Clic gauche/droit + déplacer</div>\
                    </td>\
                </tr>\
            </table>';
        ...
        touchInstructions.innerHTML = '\
            <table>\
                <tr>\
                    ...
                    <td>\
                        <div class="cesium-navigation-help-pan">Déplacer la vue</div>\
                        <div class="cesium-navigation-help-details">Déplacer avec un doigt</div>\
                    </td>\
                </tr>\
                <tr>\
                    ...
                    <td>\
                        <div class="cesium-navigation-help-zoom">Zoomer</div>\
                        <div class="cesium-navigation-help-details">Pincer avec deux doigts</div>\
                    </td>\
                </tr>\
                <tr>\
                    <td><img src="' + buildModuleUrl('Widgets/Images/NavigationHelp/TouchTilt.svg') + '" width="70" height="48" /></td>\
                    <td>\
                        <div class="cesium-navigation-help-rotate">Incliner la vue</div>\
                        <div class="cesium-navigation-help-details">Déplacer avec deux doigts, même direction</div>\
                    </td>\
                </tr>\
                <tr>\
                    <td><img src="' + buildModuleUrl('Widgets/Images/NavigationHelp/TouchRotate.svg') + '" width="70" height="48" /></td>\
                    <td>\
                        <div class="cesium-navigation-help-tilt">Rotation de la vue</div>\
                        <div class="cesium-navigation-help-details">Déplacer avec deux doigts, direction opposée</div>\
                    </td>\
                </tr>\
            </table>';
